(() => {
  ...
  function injectNavStyle() {
    ...
    style.textContent = `
      ...
      #main-site-voice-button:hover{background:#111;color:#fff}#main-site-voice-button:disabled{opacity:.6;cursor:wait}@media(max-width:620px){#main-site-voice-button{right:10px;bottom:68px;padding:9px 11px;font-size:11px}}
    `;
  ...
  function loadSiteTTS() {
    ...
    inject("assets/js/site-tts-v13.js?v=20260824-2150-approved-young-female", "data-site-tts");
  }
  ...
  function playMainLeadFromClick(button) {
    ...
    if (played) {
      ...
      button.title = "使用你原先試聽選中的 CosyVoice2-Yue-Databaker 年輕女聲播放目前頭條";
      return;
    }
  ...
  function mountVoiceLauncher() {
    ...
    voiceButton.setAttribute("aria-label", "播放 CosyVoice2-Yue-Databaker 年輕女聲頭條朗讀");
  ...
  function mountSystemPanel() {
    ...
    panel.innerHTML = `<div class="system-panel-head"><div><strong>System Status</strong><span>Maintenance & Monitoring</span></div><button type="button" class="system-panel-close" aria-label="關閉">×</button></div><div class="system-panel-row status-ok"><span class="status-dot"></span><div><strong>Website</strong><small>Static safe mode · publication layers monitored independently</small></div></div><div class="system-panel-row status-check"><span class="status-dot"></span><div><strong>Daily / Live / Stocks</strong><small>News Pipeline below separates background discovery, verified draft, main Live and public Pages</small></div></div><div class="system-panel-row status-check"><span class="status-dot"></span><div><strong>Cantonese Voice</strong><small>CosyVoice2-Yue · approved Databaker young female synthetic reference · v13 · native speed 1.0 · HK news-anchor semantic pacing</small></div></div><div class="system-panel-row status-check"><span class="status-dot"></span><div><strong>GitHub Pages / Discord</strong><small>Pages deployment has automatic main/public convergence repair</small></div></div><div class="system-panel-links"><a href="https://github.com/kanuli/daily-brief-newspaper/actions" target="_blank" rel="noopener noreferrer">GitHub Actions ↗</a><a href="https://github.com/kanuli/daily-brief-newspaper" target="_blank" rel="noopener noreferrer">Repository ↗</a></div>`;
