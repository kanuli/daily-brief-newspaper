...
def validate_story(story, label, strict=False):
    ...
    combined = ' '.join(str(story.get(k,'')) for k in ('title','dek','summary','body'))
    ...
    if strict:
        ...
        # 500 Chinese words often maps to substantially more than 500 characters once names/numbers are included.
        # Keep a generous hard ceiling to stop accidental essay dumps while allowing legitimate long reports.
        if measure > 1800:
