...
required_publish = [
    ...
    'Publish this voice immediately to main',
    'git push origin HEAD:main',
]
for token in required_publish:
    assert token in publish, f'missing immediate per-article F01 publisher contract token: {token}'
...
print('COSYVOICE_F01_PER_ARTICLE_IMMEDIATE_CONTRACT_PASS')
